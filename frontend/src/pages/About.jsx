...
/>
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Manish pal (@Manishpal0026)</h3>
  ...
  <a
    href="https://www.linkedin.com/in/manish-pal-052953258/"
    target="_blank"
    rel="noreferrer"
    style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}
  >
    💼 LinkedIn
  </a>
  ...
  <a
    href="https://www.instagram.com/manishpal___26?igsi=MWlvaDNtYzVtcGV4Ng=="
    target="_blank"
    rel="noreferrer"
  ...
  <a
    href="https://share.google/Xkz6Bj7RI1oGuEg4X"
    target="_blank"
    rel="noreferrer"
